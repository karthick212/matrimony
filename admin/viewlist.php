...
elseif($mode=='female')
{
  ...
  echo "Choose the tab";
							    ...
							    <tr>
                                    ...
                                    <td><a href='delete.php?id=<?php echo $fetch['matri_id'] ?>'> <button onclick="return confirm('Are u want to Delete Record?');" type="button" class="btn btn-danger" style="padding: 3px 6px;"><i class="far fa-trash-alt"></i></button></a></td>
							    </tr>
