...
$rfrom=$_GET['rfrom'];
$rto=$_GET['rto'];
$q="SELECT * FROM `registerfree` where reg_no='$id' ";
...
<table width="1003" border="0" align="center" style="background-image:url(images/bg.png);">
  <tr>
    ...
    <tr ><br /><td valign="bottom" height="" colspan="2" align="center" style="font-weight:bold; font-size:12px;">ஸ்ரீ லிங்கம்மாள் துணை</td></tr>
      ...
      <tr valign="top">
        ...
        <table  border="1" align="center" cellpadding="0"  id="table6" style="border-collapse: collapse;margin-left:45px;">
						<tbody class="b" style="font-weight:bold;font-size:18px;"><tr class="b" style="font-weight:bold;font-size:18px;">
							<td width="77"  >
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r1'];?> <?php
$c1=$row['one'];				
$array =  explode(',', $c1);
foreach ($array as $item) {
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77"  >
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r2'];?> <?php
$c2=$row['two'];				
$array =  explode(',', $c2);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77"  >
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r3'];?> <?php
$c3=$row['three'];				
$array =  explode(',', $c3);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77"  >
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r4'];?> <?php
$c4=$row['four'];				
$array =  explode(',', $c4);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="58">
						<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r13'];?> <?php
$c13=$row['aone'];				
$array =  explode(',', $c13);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r14'];?> <?php
$c14=$row['atwo'];				
$array =  explode(',', $c14);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r15'];?> <?php
$c15=$row['athree'];				
$array =  explode(',', $c15);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="65">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r16'];?> <?php
$c16=$row['afour'];				
$array =  explode(',', $c16);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
						...
						<tr>
							<td width="77" >
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r12'];?> <?php
$c12=$row['twelve'];				
$array =  explode(',', $c12);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r5'];?> <?php
$c5=$row['five'];				
$array =  explode(',', $c5);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r24'];?> <?php
$c24=$row['atwelve'];				
$array =  explode(',', $c24);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r17'];?> <?php
$c17=$row['afive'];						
$array =  explode(',', $c17);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
						...
						<tr>
							<td width="77" >
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r11'];?> <?php
$c11=$row['eleven'];				
$array =  explode(',', $c11);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r6'];?> <?php
$c6=$row['six'];				
$array =  explode(',', $c6);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r23'];?> <?php
$c23=$row['aeleven'];				
$array =  explode(',', $c23);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r18'];?> <?php
$c18=$row['asix'];				
$array =  explode(',', $c18);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
						...
						<tr>
							<td width="77" >
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r10'];?> <?php
$c10=$row['ten'];				
$array =  explode(',', $c10);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
						  <textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r9'];?> <?php
$c9=$row['nine'];				
$array =  explode(',', $c9);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r8'];?> <?php
$c8=$row['eight'];				
$array =  explode(',', $c8);
...
foreach ($array as $item) {
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r7'];?> <?php
$c7=$row['seven'];				
$array =  explode(',', $c7);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r22'];?> <?php
$c22=$row['aten'];				
$array =  explode(',', $c22);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r21'];?> <?php
$c21=$row['anine'];				
$array =  explode(',', $c21);
foreach ($array as $item) {
	//echo $item;
  ...
  <?php $t=trim($item); echo $t; }  ?>
							...
							<td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r20'];?> <?php
$c20=$row['aeight'];				
$array =  explode(',', $c20);
foreach ($array as $item) {
	//echo $item;
  ...
  <td width="77">
							<textarea  class="a" style="overflow: hidden; text-align:justify; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r19'];?> <?php
$c19=$row['aseven'];				
$array =  explode(',', $c19);
foreach ($array as $item) {
	//echo $item;
