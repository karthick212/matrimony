...
$rfrom=$_GET['rfrom'];
$rto=$_GET['rto'];
$q="SELECT * FROM `registerfree` where caste='$caste' ";
$result = mysql_query($q)or die(mysql_error());
$k=mysql_num_rows($result);
if($k=='')
{

echo "<script>alert('No Records Found');self.location='caste_report.php';</script>";
}
while ($row = mysql_fetch_array($result)) {
?>


<table width="1003" border="0" align="center" style="border: 2px solid #d8348e;">
  <tr><br>
    ...
    <tr ><!-- <td valign="bottom" height="" colspan="2" align="center" style="font-weight:bold; font-size:14px;font-weight:bold; color: #246d01;">ஸ்ரீ லிங்கம்மாள் துணை</td> --></tr>
      ...
      <tr align="center"><br>
        <td width="300"> <img src="<?php echo '../'. $row['up_profile']; ?>" style="width: 250px;
    height: 250px;"></td>
        <td width="300" height="" align="center" style="font-size: 40px; color:#d8348e;"> <!-- <img src="images/reg.jpg" width="400px" height="75px" /> --> Inaikkum karangal matrimony</td>
  ...
  <tr>
    <td height=""><hr/><table width="1003" border="0" style="font-weight:bold; color: #246d01;" >
      <tr>
        <td width="143" height="29" align="left"  style="padding-left:50px; font-size:12px;font-weight:bold; color: #246d01;">பெயர்</td>
        <td width="10">:</td>
        <td width="329" style="font-weight:bold;font-size:16px;font-weight:bold; color: #246d01;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?>"><?php echo  $row['name'];?></td>
        <td width="1">&nbsp;</td>
     ...
     <tr>
      ...
      <table width="1003" border="0" cellspacing="0" cellpadding="0" align="center" class="b" style="font-weight:bold;font-size:16px;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?>">
      <tr valign="top">
        ...
        <table  border="1" align="center" cellpadding="0"  id="table6" style="border-collapse: collapse;margin-left:45px;">
            <tbody class="b" style="font-weight:bold;font-size:18px;"><tr class="b" style="font-weight:bold;font-size:18px;">
              <td width="77"  >
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r1'];?> <?php
$c1=$row['one'];        
$array =  explode(',', $c1);
...
echo $t;
              ...
              <td width="77"  >
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r2'];?> <?php
$c2=$row['two'];        
$array =  explode(',', $c2);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77"  >
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r3'];?> <?php
$c3=$row['three'];        
$array =  explode(',', $c3);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77"  >
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r4'];?> <?php
$c4=$row['four'];       
$array =  explode(',', $c4);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="58">
            <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r13'];?> <?php
$c13=$row['aone'];        
$array =  explode(',', $c13);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r14'];?> <?php
$c14=$row['atwo'];        
$array =  explode(',', $c14);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r15'];?> <?php
$c15=$row['athree'];        
$array =  explode(',', $c15);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="65">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r16'];?> <?php
$c16=$row['afour'];       
$array =  explode(',', $c16);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
            ...
            <tr>
              <td width="77" >
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r12'];?> <?php
$c12=$row['twelve'];        
$array =  explode(',', $c12);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r5'];?> <?php
$c5=$row['five'];       
$array =  explode(',', $c5);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r24'];?> <?php
$c24=$row['atwelve'];       
$array =  explode(',', $c24);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r17'];?> <?php
$c17=$row['afive'];           
$array =  explode(',', $c17);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
            ...
            <tr>
              <td width="77" >
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r11'];?> <?php
$c11=$row['eleven'];        
$array =  explode(',', $c11);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r6'];?> <?php
$c6=$row['six'];        
$array =  explode(',', $c6);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r23'];?> <?php
$c23=$row['aeleven'];       
$array =  explode(',', $c23);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r18'];?> <?php
$c18=$row['asix'];        
$array =  explode(',', $c18);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
            ...
            <tr>
              <td width="77" >
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r10'];?> <?php
$c10=$row['ten'];       
$array =  explode(',', $c10);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r9'];?> <?php
$c9=$row['nine'];       
$array =  explode(',', $c9);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r8'];?> <?php
$c8=$row['eight'];        
$array =  explode(',', $c8);
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;font-family: Bamini, Helvetica, sans-serif; font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r7'];?> <?php
$c7=$row['seven'];        
$array =  explode(',', $c7);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r22'];?> <?php
$c22=$row['aten'];        
$array =  explode(',', $c22);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r21'];?> <?php
$c21=$row['anine'];       
$array =  explode(',', $c21);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r20'];?> <?php
$c20=$row['aeight'];        
$array =  explode(',', $c20);
foreach ($array as $item) {
  //echo $item;
...
echo $t;
  ...
  <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: #246d01; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r19'];?> <?php
$c19=$row['aseven'];        
$array =  explode(',', $c19);
foreach ($array as $item) {
  //echo $item;
      ...
      <tr>
        <th width="996" height=""   align="left" scope="col"><table width="99%" height="95" border="0" cellpadding="0" cellspacing="0">
         <tr >
            ...
            <td width="79%" scope="col"align="left"  class="b2"  style="font-weight: bold; color: #246d01;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-size:16px"><?php echo  $row['address'];?> , <?php echo  $row['city'];?></td>
          </tr>
          <tr >
            ...
            <td width="79%" scope="col"  align="left"  class="b2"  style="font-weight: bold; color: #246d01; font-size:20px" ><?php echo  $row['mobile'];?> </td>
          </tr>
        </table></th>
