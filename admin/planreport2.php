                                ...
                                <div class="panel-content">
                                        ...
                                        <tr>
                                             <td width="269" align="center">
                                                <select name="age1" style="width: 94px; height: 40px; " id="" required>
                                            ...
                                            <td width="269" align="center">
                                                <select name="age2" style="width: 72px; height: 40px; " id="" required>
...
<td><select style="width: 113px; height: 40px; " name="gender"><option value="">Select Gender</option>
...
<td width="269" align="center">
                                                <select name="religion" style="width: 117px; height: 40px; ">
...
<td width="240" align="center">
                                                ...
                                                <select name="caste" style="width: 141px; height: 40px; ">
      ...
      ?>
                                            ...
                                            <input type="submit" class="btn btn-success" name="submit" style="
    width: 153px;
...
//$income=$_POST['income'];
	...
	echo"<script>window.location.href='view_report.php?age1=$age1&age2=$age2&gender=$gender&caste=$caste&thosam=$thosam&religion=$religion';</script>";
