...
<br>
 ...
 <button><a href="planreport1.php">Back</a></button>
    ...
    if($age1 != '' && $age2 != '' && $religion != '' && $caste != '' &&
                        ...
                        elseif($age1 != '' && $age2 != ''){
                            ...
                            //echo $sql;
                             ...
                             echo "<script>alert('Please Select the age'); window.location.href='planreport1.php'</script>";
                        }
     ...
     <td> <a class="foss" target="_blank" href="viewprofile.php?id=<?php echo $row['matri_id'];?>"><?php echo  $row['matri_id'];?></a></td>
      <td> <a class="foss" target="_blank" href="viewprofile.php?id=<?php echo $row['matri_id'];?>"><?php echo  $row['name'];?></a></td>
       <td> <a class="foss" target="_blank" href="viewprofile.php?id=<?php echo $row['matri_id'];?>"><?php echo  $row['caste'];?></a></td>
        ...
        <td>
            <a class="example-image-link" href="<?php echo '../'.$row['up_profile']; ?>" data-lightbox="example-set"
             data-title="../<?php echo $row['name']; ?>">
                <img id="myImg" class="example-image" src="<?php echo '../'.$row['up_profile']; ?>" style="width:300px; height:300px;">
</a>   
    </td>
