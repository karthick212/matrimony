...
$sql="update add_customer set name='$name',email_id='$email_id',phone_number='$phone_number',user_name='$user_name' where id='$id'";	
    ...
    <div class="page-body">
        ...
        <div class="content">
            ...
            <div class="row animated fadeInUp">
                ...
                <div class="col-md-12">
                    <h4 class="section-subtitle">Edit <b> Customer </b></h4>
                    <div class="panel">
...
{?>
                                    ...
                                    <form class="form-horizontal form-stripe" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="name" class="form-control" id="name" placeholder="Name" value="<?php echo $res['name']; ?>" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="email_id" class="col-sm-2 control-label">Email Id</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="email_id" class="form-control" id="email_id" placeholder="Email Id" value="<?php echo $res['email_id']; ?>" >
                                            </div>
                                        </div>
                                      <div class="form-group">
                                            <label for="phone_number" class="col-sm-2 control-label">Phone Number</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="phone_number" class="form-control" id="phone_number" placeholder="Phone Number" value="<?php echo $res['phone_number']; ?>" >
                                            </div>
                                        </div>
                                      <div class="form-group">
                                            <label for="user_name" class="col-sm-2 control-label">User Name</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="user_name" class="form-control" id="user_name" placeholder="User Name" value="<?php echo $res['user_name']; ?>" >
                                            </div>
                                        </div>
                                       ...
                                       <!-- <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text"  name="password" class="form-control" id="password" placeholder="Password" value="<?php echo $res['password']; ?>">
                                            </div>
                                        </div>-->
