  ...
  $age1=$_GET['age1'];
    ...
    if($age1 != '' && $age2 != '' && $religion != '' && $caste != '' &&
                         $thosam != '' && $gender != '')
                        {
                            ...
                            age<='$age2' AND religion='$religion' AND caste='$caste' AND thosam='$thosam' AND gender='$gender'" ;
                            // echo $sql;
                        ...
                        elseif($age1 != '' && $age2 != '' && $religion != '' && $caste != ''  && $thosam != '')
                        {
                            ...
                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND 
                            age<='$age2' AND religion='$religion' AND caste='$caste' AND thosam='$thosam' ";
                        ...
                        {
                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND 
                            age<='$age2' AND religion='$religion' AND caste='$caste' ";
                            
                        }
                        elseif($age1 != '' && $age2 != '' && $thosam != '' && $religion != '' ){

                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND 
                            age<='$age2' AND religion='$religion' AND thosam='$thosam' ";
                        }
                        elseif($age1 != '' && $age2 != '' && $religion != '')
                        {
                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND 
                            age<='$age2' AND religion='$religion'";
                        }
                        ...
                        elseif($age1 != '' && $age2 != '' && $caste != ''){
                            ...
                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND 
                            age<='$age2' AND caste='$caste' ";
                        }
                        elseif($age1 != '' && $age2 != '' && $thosam != '' ){

                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND 
                            age<='$age2' AND thosam='$thosam'  ";
                        }
                        elseif($age1 != '' && $age2 != ''  && $gender != ''){

                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND 
                            age<='$age2' AND gender='$gender' ";
                        }
                        elseif($age1 != '' && $age2 != ''){
                            ...
                            //echo $sql;
                             ...
                             echo "<script>alert('Please Select the age'); window.location.href='report.php'</script>";
                        }
...
echo "<script>alert('No Records Found');self.location='report.php';</script>";
    //echo $sql;
}
$s_no=1;
while ($row = mysql_fetch_array($result)) {
  ...
  <tr style="text-align: center;background: aliceblue;">
   <td> <a class="foss" href="#"><?php echo $s_no++; ?></a></td>
     <td> <a class="foss" href="viewprofile.php?id=<?php echo $row['matri_id'];?>"><?php echo  $row['matri_id'];?></a></td>
      <td> <a class="foss" href="viewprofile.php?id=<?php echo $row['matri_id'];?>"><?php echo  $row['name'];?></a></td>
       <td> <a class="foss" href="viewprofile.php?id=<?php echo $row['matri_id'];?>"><?php echo  $row['caste'];?></a></td>
        <td> <a class="foss" href="viewprofile.php?id=<?php echo $row['matri_id'];?>"><?php echo  $row['subcaste'];?></a></td>
