...
<html class=""><head>
 ...
 <div class="container">
    ...
    <br> 
<h3><button><a href="viewlist.php?mode=all">Go Back</a></button></h3>
 ...
 $cc=mysql_num_rows($res1);
if($cc==0)


  echo "<script>alert('NO Records Found');self.location='viewlist.php?mode=all'</script>";
    ...
    <tr ><br /><td valign="bottom" height="" colspan="2" align="center" style="font-weight:bold; font-size:12px;"></td></tr>
      ...
      <tr align="center">
        ...
        <td>
          ...
          <img src="images/images/LOGOss.png" style="
    margin-left: 40px;
" alt="Wedding Vendors" class="img-responsive" style=""></td>
    ...
    font-weight: 700;"><b>Reg.No:
             ...
             <a href="edit_profile.php?id=<?php echo $row['matri_id']; ?>"><button class="btn-hover color-10">Edit Profile</button></a><br>
