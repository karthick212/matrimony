                    ...
                    <h4 class="section-subtitle"><b>Search </b>  Profile</h4>
                      <div class="panel">
                        ...
                        <div class="panel-content">
                         ...
                         if($age1 != '' && $age2 != '' && $religion != '' && $caste != '' && $gender != '')
                        {
                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND age<='$age2' AND religion='$religion' AND caste='$caste' AND gender='$gender' order by id desc" ;
                            
                        }
                        elseif($age1 != '' && $age2 != '' && $religion != '' && $caste != '')
                        {

                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND  age<='$age2' AND religion='$religion' AND caste='$caste' order by id desc ";
                           
                        }
                        elseif($age1 != '' && $age2 != '' && $gender != '' && $caste != '')
                        {
                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND age<='$age2'  AND caste='$caste' AND gender='$gender' order by id desc";
                        ...
                        {
                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND age<='$age2' AND religion='$religion' order by id desc";
                            
                        }
                        
                        elseif($age1 != '' && $age2 != '' && $caste != ''){

                            $sql="SELECT * FROM registerfree WHERE age>='$age1' AND  age<='$age2' AND caste='$caste' order by id desc";
                        ...
                        elseif($age1 != '' && $age2 != ''){
                            ...
                            //echo $sql;
                             ...
                             echo "<script>alert('Please Select the age');window.loctaion.href='planreport2.php'
                              </script>";
                        }
                        //echo $sql;
							    ...
							    <tr>
                                    ...
                                    <td><a href="viewprofile.php?id=<?php echo $fetch['matri_id']; ?>"><?php echo $fetch['address']; ?></a></td>
            ...
            <!-- Modal content-->
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                         <img src="../<?php echo $fetch['up_profile']; ?>" style="width:100%;"/>
                    </div>
                </div>
            </div>
         </div>
