          ...
          <td width="346"> <table width="246" border="0" cellspacing="0" cellpadding="0">
            <div id="myModal" class="modal fade" role="dialog">
              <div class="modal-dialog modal-sm" style="width: 400px;">
                <div class="modal-content" style="background-color: #eb0c99">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title" style="color: white">Contact Details</h4>
                  </div>
      ...
      <tr class="heig">
        ...
        <tr class="heig">
         <td width="227" height="29" align="left" class="tdheader">Brother's</td>
          <td class="tdheader">:</td>
         <td width="311"  class="tdvalue"><?php echo  $row['bro'];?></td>
         <td width="1">&nbsp;</td>
         <td width="163" align="left" class="tdheader">Sister's</td>
          <td class="tdheader">:</td>
         <td width="250" class="tdvalue"><?php echo  $row['sis'];?></td>
       </tr>
       <tr class="heig"></tr>
