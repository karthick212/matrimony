...
<html class=""><head>
    ...
    <br>
     <br>
      <br>
      <!-- <a href="profiless.php" style="margin-left:20px;"><button>Go Back</button></a>-->
    <section>
 <div class="container">
...
?></td>
      ...
      <tr>
        ...
        <td width="1">&nbsp;</td>
         <td width="163" align="left"style="padding-left:50px;font-size: 11px;font-weight: bold;">Mother Occupation</td>
        <td>:</td>
