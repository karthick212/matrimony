...
//echo $profiles;
  ...
  '$target_dir','$address','$mail','$mobile','$land','$profiles','$comments','$ybrothers','$ysisters','$bplace','$city','$thosh','0')";
  ...
  <section style="background:url(images/regbac.jpg);">
    <div class="container">
      ...
      <div class="row fadeInUp animated">
          ...
          <div class="row divborder pag">
            ...
            <div class="form-group">
              ...
              <div class="col-md-4 divborder1">
                <input type="text" class="form-control input-sm textbox1" name="name" id="name" placeholder="Enter Name" value="" data-title="Please valid Name">
              </div>
            </div>
            ...
            <div class="col-md-4 divborder1">
              <div class="form-group" style="margin-top: -20px;">
                <label class="radio-inline" style="margin-left: -40px;">
                  <input type="radio" name="sex" id="optionsRadios3" class="form-control input-sm" value="Male" checked=""><span class="regp">Male</span>
                </label>
                <label class="radio-inline"> 
                  <input type="radio" name="sex" id="optionsRadios4" class="form-control input-sm" value="Female"><span class="regp">Female</span>
                </label>
              </div>
            </div>
            ...
            <div class="col-md-4 divborder1">
              <div class="form-group">
                <select class="form-control required combo input-sm" name="caste" id="caste" data-title="Please select Caste">
                 <option value="default">Caste</option>
        ...
        <div class="col-md-4 divborder1">
          <div class="form-group">
            <input type="text" class="form-control" style="height: 30px;" id="exampleInputDOB1" name="qualification" placeholder="Qualification" value="">
          </div>
        </div>
...
12.Any unauthorized use terminates the permission or license granted by Our matrimony. You may not use any Our matrimony logo or other proprietary graphic or trademark as part of the link without express written permission.</p>
            ...
            <div class="col-md-12 divborder1" style="margin-top: 1em;text-align:center">
              ...
              color: #fff;
              font-size: 21px;" onclick="return validate(document);" name="registers" class="btn">REGISTER</button>
            </div>
