    ...
    <br>
     <br>
      <br>
       ...
       <a href="profiles.php" style="margin-left:20px;"><button>Go Back</button></a>
    <section>
 <div class="container">
...
//echo "testttttttt123";
        ...
        <td width:"400">
          ...
          <img style="margin-left: 45px;" src="images/LOGOss.png" alt="Wedding Vendors" class="img-responsive" style="">
<p style="font-size: 18px;
    ...
    font-weight: 700;"><b>Reg.No:
             ...
             <a href=""><button class="btn-hover color-10">Print</button>
             </a>
