...
<div class="single" style="background: #f74d70;color: black;font-size: 18px;padding: 24px 0px;">
    <div class="container">
    ...
    <div class="page-container" style="padding-left:0px;"> 
         <?php
            ...
            $sql1="SELECT matri_id,name,gender,age,edu,caste,up_profile FROM registerfree WHERE id<>'0' " . $cond ." order by id desc" ;
