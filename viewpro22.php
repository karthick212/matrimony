...
<!--     <meta name="viewport" content="width=device-width, initial-scale=1">
 ...
 <div class="container">
      <div class="row" style="">
        ...
        <div class="col-md-6">
     <a href="viewlist1.php?mode=all"><div class="open-buttons" style="text-align: center;">Back</div></a>
       ...
       if(isset($_POST['search_id1']))
        {
          ...
          //echo $mat_id;
           ...
           $sql1="SELECT * FROM registerfree WHERE name = '$mat_id'";
...
while($row = mysql_fetch_assoc($res1))
{
  ...
  ?>
    ...
    <div class="container" align="center" style="border:1px solid #8b0000;background-image: radial-gradient(#ff000038, #ffff0052, #eb0c99);">
    ...
    <tr ><br /><td valign="bottom" height="" colspan="2" align="center" style="font-weight:bold; font-size:12px;"></td></tr>
      ...
      <tr align="center">
        ...
        <td>
          ...
          <img src="images/LOGOss.png" alt="Wedding Vendors" class="img-responsive" style="margin-left:40px;"></td>
      <td width="346"> <table width="246" border="0" cellspacing="0" cellpadding="0">
          <tr >

            <p style="font-size: 18px;
    font-weight: 700;"><b>Reg.No:
             <span style="font-size:26px"></span><?php echo $row['matri_id']; ?></b><br>
             
             <a href="edit_profile1.php?id=<?php echo $row['matri_id']; ?>"><button class="btn-hover color-10">Edit Profile</button></a><br>
            
             <a href="pic.php?id=<?php echo $row['matri_id']; ?>"><button class="btn-hover color-10">Manage Photos</button>
             </a>
