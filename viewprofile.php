...
<html class=""><head>
    ...
    <section id="sidebarCollapse" class="side-menu mCustomScrollbar _mCS_1"><div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" tabindex="0"><div id="mCSB_1_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
      ...
      <div class="side-menu-widget gallery-widget">
        ...
        <ul class="list-inline">
          <li><a href="#"><img src="images/gallery-thumb/1.jpg" alt="Awesome Image" class="mCS_img_loaded"></a></li>
          <li><a href="#"><img src="images/gallery-thumb/2.jpg" alt="Awesome Image" class="mCS_img_loaded"></a></li>
          <li><a href="#"><img src="images/gallery-thumb/3.jpg" alt="Awesome Image" class="mCS_img_loaded"></a></li>
          <li><a href="#"><img src="images/gallery-thumb/4.jpg" alt="Awesome Image" class="mCS_img_loaded"></a></li>
          <li><a href="#"><img src="images/gallery-thumb/5.jpg" alt="Awesome Image" class="mCS_img_loaded"></a></li>
          <li><a href="#"><img src="images/gallery-thumb/6.jpg" alt="Awesome Image" class="mCS_img_loaded"></a></li>
          <li><a href="#"><img src="images/gallery-thumb/7.jpg" alt="Awesome Image" class="mCS_img_loaded"></a></li>
          <li><a href="#"><img src="images/gallery-thumb/8.jpg" alt="Awesome Image" class="mCS_img_loaded"></a></li>
        </ul>
        <!-- /.list-inline-->
    ...
    <br>
     <br>
      <br>
      <!-- <a href="freesearch1.php" style="margin-left:20px;"><button class="btn-hover color-10">Back to Search Profile</button></a>-->
<section>
 <div class="container">
      <div class="row" style="margin-left: 35px;text-align: -webkit-right;">
       ...
       <div class="open-buttons" style="text-align: center; margin-right: 420px;
    text-align: center;">Back</div> 
      <a href="express.php?fid=<?php echo $mat_id;?>&tid=<?php echo $t_id; ?>"><div class="open-buttons" style="text-align: center;"> Interest</div></a>
    </div> -->
    <?php
    if(isset($_GET['id']))
        {
   ...
   <!--  <div class="col-md-6">
       <a href="contact1.php?fid=<?php echo $mat_id;?>&tid=<?php echo $t_id; ?>"><div class="open-buttonss">Contact Details </div></a>
...
<p style="font-size: 18px;
    ...
    <input type="hidden" name="matri_id" id="matri_id" value="<?php echo $_SESSION['matri_id']?>">
             ...
             <a href="express.php?fid=<?php echo $mat_id;?>&tid=<?php echo $t_id; ?>"><button class="btn-hover color-10" id="print"> Interest</button></a>
           <!--  contact1.php?fid=<?php echo $mat_id;?>&tid=<?php echo $t_id; ?> -->
             <a href="#"><button class="btn-hover color-10" id="print1" data-toggle="modal" data-target="#myModal">Contact Details </button>
             </a>
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog modal-sm" >
    ...
    font-weight: 700;"><b>Reg.No:
             ...
             <a href="edit_profile.php?id=<?php echo $mat_id; ?>"><button class="btn-hover color-10" id="print2">Edit Profile</button></a><br>
            
             <a href="pic.php?id=<?php echo $mat_id; ?>"><button class="btn-hover color-10" id="print3">Manage Photos</button>
             </a>
             
             <a href=""><button class="btn-hover color-10" id="print4" onclick="PrintDiv()">Print</button>
             </a>
...
?></td>
      ...
      <!-- <tr>
        ...
        <td width="1">&nbsp;</td>
         <td width="163" align="left" style="padding-left:50px;font-size: 13px;font-weight: bold;">Phone no:</td>
        <td>:</td>
        <td width="250" style="font-weight:bold;font-size:18px;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?>">
          <?php
          echo $row['mobile'];
