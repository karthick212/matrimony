...
echo "<script> window.location.href='profiless.php'</script>";
      ...
      <div class="form-popup pop" id="myForm">
        <form class="form-container" action="index.php" method="post" style="border: 10px solid white">
          <h4 style="color:white;text-align: center;border: 2px solid white;padding: inherit;">MEMBER LOGIN</h4>
      ...
      <ul class="list-inline">
        ...
        <li class="l-style">
          ...
          <a class="pad open-button" href="freeregisterationtamil.php">இலவச பதிவுக்கு</a>
        </li>
      </ul>
    </div>
