...
if(isset($_POST['registers']))
{
   $dob1=$_POST['dob'];
    ...
    $g= explode('-',$dob1);
         ...
         //echo $d1;
$d2=$d1-$g[0];
  $sql="UPDATE registerfree SET `name`='$name',`caste`='$caste',`subcaste`='$subcaste',`dob`='$dob',`dot`='$dot',`age`='$d2',`height`='$height',`color`='$color',`edu`='$qualification',`working_place`='$work_place',`monthlyincome`='$income',`phy`='$phy',`mstatus`='$mstatus',`religion`='$religion',`god`='$god',`weight`='$weight',`food`='$food',`father_name`='$f_name',`mother_name`='$m_name',`father_occ`='$f_occ',`mother_occ`='$m_occ',`bro`='$bro',`sis`='$sis',`mbro`='$mbro',`msis`='$msis',`language`='$lang',`expectation`='$expect',`f_status`='$f_status',`lagnam`='$lagnam',`star`='$star',`rasi`='$rasi',`gothram`='$gothram',`thisai`='$thisai',`email`='$mail',`ybrother`='$ybro',`ysister`='$ysis',`birth_place`='$bplace',`gender`='$sex' WHERE matri_id='$mat_id' ";
  // echo $sql;
  $res=mysql_query($sql);
  if($res==true)
  {
     echo "<script>alert('updated successfully'); window.location.href='all1.php?mode=all'</script>";
...
<input type="radio" name="sex"  class="form-control input-sm" value="Female" >
          ...
          <?php } ?>   <span class="regp">Female</span>   
            ...
            <div class="col-xs-12 col-md-2 divborder1"><label class="control-label"> Gender</label></div>
        <div class="col-md-4 divborder1">
          <div class="form-group">
           

            <select class="form-control required combo input-sm" name="sex">
...
<option>Meenam</option>
      ...
      <option value="Karthigai 4" selected=""> Karthigai 4 </option>
  ...
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0" style="color:#000;">
        <tbody style="color: beige;"><tr id="tr1rpu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rpu" value="புதன்" onclick="return uncheck('rpu','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr1rsun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rsun" value="சூரியன்" onclick="return uncheck('rsun','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr1rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rragu" value="ராகு" onclick="return uncheck('rragu','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr1rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rvij" value="வியாழன்" onclick="return uncheck('rvij','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr1rchk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr1rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rchan" value="சந்திரன்" onclick="return uncheck('rchan','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr1rkee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rkee" value="கேது" onclick="return uncheck('rkee','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr1rsev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rsev" value="செவ்வாய்" onclick="return uncheck('rsev','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr1rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi1[]" id="1rlac" value="லக்னம்" onclick="return uncheck('rlac','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr2rpu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rpu" value="புதன்" onclick="return uncheck('rpu','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr2rsun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rsun" value="சூரியன்" onclick="return uncheck('rsun','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr2rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rragu" value="ராகு" onclick="return uncheck('rragu','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr2rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rvij" value="வியாழன்" onclick="return uncheck('rvij','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr2rchk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr2rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rchan" value="சந்திரன்" onclick="return uncheck('rchan','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr2rkee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rkee" value="கேது" onclick="return uncheck('rkee','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr2rsev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rsev" value="செவ்வாய்" onclick="return uncheck('rsev','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr2rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi2[]" id="2rlac" value="லக்னம்" onclick="return uncheck('rlac','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr3rpu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rpu" value="புதன்" onclick="return uncheck('rpu','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr3rsun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rsun" value="சூரியன்" onclick="return uncheck('rsun','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr3rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rragu" value="ராகு" onclick="return uncheck('rragu','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr3rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rvij" value="வியாழன்" onclick="return uncheck('rvij','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr3rchk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr3rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rchan" value="சந்திரன்" onclick="return uncheck('rchan','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr3rkee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rkee" value="கேது" onclick="return uncheck('rkee','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr3rsev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rsev" value="செவ்வாய்" onclick="return uncheck('rsev','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr3rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi3[]" id="3rlac" value="லக்னம்" onclick="return uncheck('rlac','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr4rpu">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rpu" value="புதன்" onclick="return uncheck('rpu','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr4rsun">
    <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rsun" value="சூரியன்" onclick="return uncheck('rsun','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr4rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rragu" value="ராகு" onclick="return uncheck('rragu','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr4rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rvij" value="வியாழன்" onclick="return uncheck('rvij','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr4rchk">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr4rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rchan" value="சந்திரன்" onclick="return uncheck('rchan','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr4rkee">
    <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rkee" value="கேது" onclick="return uncheck('rkee','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr4rsev">
     <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rsev" value="செவ்வாய்" onclick="return uncheck('rsev','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr4rlac">
        <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi4[]" id="4rlac" value="லக்னம்" onclick="return uncheck('rlac','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr12rpu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rpu" value="புதன்" onclick="return uncheck('rpu','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr12rsun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rsun" value="சூரியன்" onclick="return uncheck('rsun','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr12rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rragu" value="ராகு" onclick="return uncheck('rragu','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr12rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rvij" value="வியாழன்" onclick="return uncheck('rvij','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr12rchk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr12rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rchan" value="சந்திரன்" onclick="return uncheck('rchan','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr12rkee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rkee" value="கேது" onclick="return uncheck('rkee','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr12rsev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rsev" value="செவ்வாய்" onclick="return uncheck('rsev','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr12rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi12[]" id="12rlac" value="லக்னம்" onclick="return uncheck('rlac','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr5rpu">
        <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rpu" value="புதன்" onclick="return uncheck('rpu','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr5rsun">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rsun" value="சூரியன்" onclick="return uncheck('rsun','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr5rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rragu" value="ராகு" onclick="return uncheck('rragu','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr5rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rvij" value="வியாழன்" onclick="return uncheck('rvij','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr5rchk">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr5rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rchan" value="சந்திரன்" onclick="return uncheck('rchan','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr5rkee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rkee" value="கேது" onclick="return uncheck('rkee','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr5rsev">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rsev" value="செவ்வாய்" onclick="return uncheck('rsev','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr5rlac">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi5[]" id="5rlac" value="லக்னம்" onclick="return uncheck('rlac','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr11rpu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rpu" value="புதன்" onclick="return uncheck('rpu','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr11rsun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rsun" value="சூரியன்" onclick="return uncheck('rsun','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr11rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rragu" value="ராகு" onclick="return uncheck('rragu','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr11rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rvij" value="வியாழன்" onclick="return uncheck('rvij','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        ...
        <tr id="tr11rchk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr11rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rchan" value="சந்திரன்" onclick="return uncheck('rchan','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr11rkee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rkee" value="கேது" onclick="return uncheck('rkee','11')">
        ...
        <tr id="tr11rsev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rsev" value="செவ்வாய்" onclick="return uncheck('rsev','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr11rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi11[]" id="11rlac" value="லக்னம்" onclick="return uncheck('rlac','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr6rpu">
        <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rpu" value="புதன்" onclick="return uncheck('rpu','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr6rsun">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rsun" value="சூரியன்" onclick="return uncheck('rsun','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr6rragu">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rragu" value="ராகு" onclick="return uncheck('rragu','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr6rvij">
        <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rvij" value="வியாழன்" onclick="return uncheck('rvij','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr6rchk">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr6rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rchan" value="சந்திரன்" onclick="return uncheck('rchan','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr6rkee">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rkee" value="கேது" onclick="return uncheck('rkee','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr6rsev">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rsev" value="செவ்வாய்" onclick="return uncheck('rsev','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr6rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi6[]" id="6rlac" value="லக்னம்" onclick="return uncheck('rlac','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr10rpu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rpu" value="புதன்" onclick="return uncheck('rpu','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr10rsun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rsun" value="சூரியன்" onclick="return uncheck('rsun','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr10rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rragu" value="ராகு" onclick="return uncheck('rragu','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr10rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rvij" value="வியாழன்" onclick="return uncheck('rvij','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr10rchk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr10rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rchan" value="சந்திரன்" onclick="return uncheck('rchan','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr10rkee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rkee" value="கேது" onclick="return uncheck('rkee','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr10rsev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rsev" value="செவ்வாய்" onclick="return uncheck('rsev','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr10rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi10[]" id="10rlac" value="லக்னம்" onclick="return uncheck('rlac','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr9rpu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rpu" value="புதன்" onclick="return uncheck('rpu','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr9rsun">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rsun" value="சூரியன்" onclick="return uncheck('rsun','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr9rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rragu" value="ராகு" onclick="return uncheck('rragu','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr9rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rvij" value="வியாழன்" onclick="return uncheck('rvij','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr9rchk">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr9rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rchan" value="சந்திரன்" onclick="return uncheck('rchan','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr9rkee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rkee" value="கேது" onclick="return uncheck('rkee','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr9rsev">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rsev" value="செவ்வாய்" onclick="return uncheck('rsev','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr9rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi9[]" id="9rlac" value="லக்னம்" onclick="return uncheck('rlac','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr8rpu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rpu" value="புதன்" onclick="return uncheck('rpu','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr8rsun">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rsun" value="சூரியன்" onclick="return uncheck('rsun','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr8rragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rragu" value="ராகு" onclick="return uncheck('rragu','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr8rvij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rvij" value="வியாழன்" onclick="return uncheck('rvij','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr8rchk">
     <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr8rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rchan" value="சந்திரன்" onclick="return uncheck('rchan','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr8rkee">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rkee" value="கேது" onclick="return uncheck('rkee','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr8rsev">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rsev" value="செவ்வாய்" onclick="return uncheck('rsev','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr8rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi8[]" id="8rlac" value="லக்னம்" onclick="return uncheck('rlac','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr7rpu">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rpu" value="புதன்" onclick="return uncheck('rpu','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr7rsun">
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rsun" value="சூரியன்" onclick="return uncheck('rsun','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr7rragu">
        <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rragu" value="ராகு" onclick="return uncheck('rragu','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr7rvij">
        <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rvij" value="வியாழன்" onclick="return uncheck('rvij','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr7rchk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rchk" value="சுக்கிரன்" onclick="return uncheck('rchk','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
       ...
       <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rsat" value="சனி" onclick="return uncheck('rsat','7')">
        ...
        <tr id="tr7rchan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rchan" value="சந்திரன்" onclick="return uncheck('rchan','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr7rkee">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rkee" value="கேது" onclick="return uncheck('rkee','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr7rsev">
      <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rsev" value="செவ்வாய்" onclick="return uncheck('rsev','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr7rlac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="raasi7[]" id="7rlac" value="லக்னம்" onclick="return uncheck('rlac','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr1apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1apu" value="புதன்" onclick="return uncheck('apu','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr1asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1asun" value="சூரியன்" onclick="return uncheck('asun','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr1aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1aragu" value="ராகு" onclick="return uncheck('aragu','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr1avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1avij" value="வியாழன்" onclick="return uncheck('avij','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr1achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1achk" value="சுக்கிரன்" onclick="return uncheck('achk','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr1achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1achan" value="சந்திரன்" onclick="return uncheck('achan','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr1akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1akee" value="கேது" onclick="return uncheck('akee','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr1asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1asev" value="செவ்வாய்" onclick="return uncheck('asev','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr1alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam1[]" id="1alac" value="லக்னம்" onclick="return uncheck('alac','1')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr2apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2apu" value="புதன்" onclick="return uncheck('apu','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr2asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2asun" value="சூரியன்" onclick="return uncheck('asun','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr2aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2aragu" value="ராகு" onclick="return uncheck('aragu','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr2avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2avij" value="வியாழன்" onclick="return uncheck('avij','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr2achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2achk" value="சுக்கிரன்" onclick="return uncheck('achk','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr2achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2achan" value="சந்திரன்" onclick="return uncheck('achan','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr2akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2akee" value="கேது" onclick="return uncheck('akee','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr2asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2asev" value="செவ்வாய்" onclick="return uncheck('asev','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr2alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam2[]" id="2alac" value="லக்னம்" onclick="return uncheck('alac','2')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr3apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3apu" value="புதன்" onclick="return uncheck('apu','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr3asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3asun" value="சூரியன்" onclick="return uncheck('asun','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr3aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3aragu" value="ராகு" onclick="return uncheck('aragu','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr3avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3avij" value="வியாழன்" onclick="return uncheck('avij','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        ...
        <tr id="tr3achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3achk" value="சுக்கிரன்" onclick="return uncheck('achk','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr3achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3achan" value="சந்திரன்" onclick="return uncheck('achan','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr3akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3akee" value="கேது" onclick="return uncheck('akee','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr3asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3asev" value="செவ்வாய்" onclick="return uncheck('asev','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr3alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam3[]" id="3alac" value="லக்னம்" onclick="return uncheck('alac','3')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr4apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4apu" value="புதன்" onclick="return uncheck('apu','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr4asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4asun" value="சூரியன்" onclick="return uncheck('asun','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr4aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4aragu" value="ராகு" onclick="return uncheck('aragu','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr4avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4avij" value="வியாழன்" onclick="return uncheck('avij','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr4achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4achk" value="சுக்கிரன்" onclick="return uncheck('achk','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr4achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4achan" value="சந்திரன்" onclick="return uncheck('achan','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr4akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4akee" value="கேது" onclick="return uncheck('akee','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr4asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4asev" value="செவ்வாய்" onclick="return uncheck('asev','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr4alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam4[]" id="4alac" value="லக்னம்" onclick="return uncheck('alac','4')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr12apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12apu" value="புதன்" onclick="return uncheck('apu','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr12asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12asun" value="சூரியன்" onclick="return uncheck('asun','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr12aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12aragu" value="ராகு" onclick="return uncheck('aragu','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr12avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12avij" value="வியாழன்" onclick="return uncheck('avij','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
        ...
        <tr id="tr12achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12achk" value="சுக்கிரன்" onclick="return uncheck('achk','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr12achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12achan" value="சந்திரன்" onclick="return uncheck('achan','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr12akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12akee" value="கேது" onclick="return uncheck('akee','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr12asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12asev" value="செவ்வாய்" onclick="return uncheck('asev','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr12alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam12[]" id="12alac" value="லக்னம்" onclick="return uncheck('alac','12')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr5apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5apu" value="புதன்" onclick="return uncheck('apu','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr5asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5asun" value="சூரியன்" onclick="return uncheck('asun','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr5aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5aragu" value="ராகு" onclick="return uncheck('aragu','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr5avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5avij" value="வியாழன்" onclick="return uncheck('avij','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr5achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5achk" value="சுக்கிரன்" onclick="return uncheck('achk','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr5achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5achan" value="சந்திரன்" onclick="return uncheck('achan','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr5akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5akee" value="கேது" onclick="return uncheck('akee','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr5asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5asev" value="செவ்வாய்" onclick="return uncheck('asev','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr5alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam5[]" id="5alac" value="லக்னம்" onclick="return uncheck('alac','5')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr11apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11apu" value="புதன்" onclick="return uncheck('apu','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr11asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11asun" value="சூரியன்" onclick="return uncheck('asun','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr11aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11aragu" value="ராகு" onclick="return uncheck('aragu','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr11avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11avij" value="வியாழன்" onclick="return uncheck('avij','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr11achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11achk" value="சுக்கிரன்" onclick="return uncheck('achk','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr11achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11achan" value="சந்திரன்" onclick="return uncheck('achan','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr11akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11akee" value="கேது" onclick="return uncheck('akee','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr11asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11asev" value="செவ்வாய்" onclick="return uncheck('asev','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr11alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam11[]" id="11alac" value="லக்னம்" onclick="return uncheck('alac','11')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr6apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6apu" value="புதன்" onclick="return uncheck('apu','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr6asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6asun" value="சூரியன்" onclick="return uncheck('asun','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr6aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6aragu" value="ராகு" onclick="return uncheck('aragu','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr6avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6avij" value="வியாழன்" onclick="return uncheck('avij','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr6achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6achk" value="சுக்கிரன்" onclick="return uncheck('achk','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr6achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6achan" value="சந்திரன்" onclick="return uncheck('achan','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr6akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6akee" value="கேது" onclick="return uncheck('akee','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr6asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6asev" value="செவ்வாய்" onclick="return uncheck('asev','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr6alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam6[]" id="6alac" value="லக்னம்" onclick="return uncheck('alac','6')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr10apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10apu" value="புதன்" onclick="return uncheck('apu','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr10asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10asun" value="சூரியன்" onclick="return uncheck('asun','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr10aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10aragu" value="ராகு" onclick="return uncheck('aragu','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr10avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10avij" value="வியாழன்" onclick="return uncheck('avij','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr10achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10achk" value="சுக்கிரன்" onclick="return uncheck('achk','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr10achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10achan" value="சந்திரன்" onclick="return uncheck('achan','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr10akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10akee" value="கேது" onclick="return uncheck('akee','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr10asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10asev" value="செவ்வாய்" onclick="return uncheck('asev','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr10alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam10[]" id="10alac" value="லக்னம்" onclick="return uncheck('alac','10')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr9apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9apu" value="புதன்" onclick="return uncheck('apu','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr9asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9asun" value="சூரியன்" onclick="return uncheck('asun','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr9aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9aragu" value="ராகு" onclick="return uncheck('aragu','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr9avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9avij" value="வியாழன்" onclick="return uncheck('avij','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr9achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9achk" value="சுக்கிரன்" onclick="return uncheck('achk','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr9achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9achan" value="சந்திரன்" onclick="return uncheck('achan','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr9akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9akee" value="கேது" onclick="return uncheck('akee','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr9asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9asev" value="செவ்வாய்" onclick="return uncheck('asev','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr9alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam9[]" id="9alac" value="லக்னம்" onclick="return uncheck('alac','9')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr8apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8apu" value="புதன்" onclick="return uncheck('apu','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr8asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8asun" value="சூரியன்" onclick="return uncheck('asun','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr8aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8aragu" value="ராகு" onclick="return uncheck('aragu','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr8avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8avij" value="வியாழன்" onclick="return uncheck('avij','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr8achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8achk" value="சுக்கிரன்" onclick="return uncheck('achk','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr8achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8achan" value="சந்திரன்" onclick="return uncheck('achan','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr8akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8akee" value="கேது" onclick="return uncheck('akee','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr8asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8asev" value="செவ்வாய்" onclick="return uncheck('asev','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr8alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam8[]" id="8alac" value="லக்னம்" onclick="return uncheck('alac','8')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
...
<table cellpadding="0" cellspacing="0" border="0">
  <tbody><tr>
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        <tbody><tr id="tr7apu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7apu" value="புதன்" onclick="return uncheck('apu','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">பு</td>
        </tr>
        <tr id="tr7asun">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7asun" value="சூரியன்" onclick="return uncheck('asun','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சூ</td>
        </tr>
        <tr id="tr7aragu">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7aragu" value="ராகு" onclick="return uncheck('aragu','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ரா</td>
        </tr>
        <tr id="tr7avij">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7avij" value="வியாழன்" onclick="return uncheck('avij','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">வி</td>
        </tr>
        <tr id="tr7achk">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7achk" value="சுக்கிரன்" onclick="return uncheck('achk','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சு</td>
        </tr>
    ...
    <td valign="top"><table cellpadding="0" cellspacing="0" border="0">
        ...
        <tr id="tr7achan">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7achan" value="சந்திரன்" onclick="return uncheck('achan','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">சந்</td>
        </tr>
        <tr id="tr7akee">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7akee" value="கேது" onclick="return uncheck('akee','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">கே</td>
        </tr>
        <tr id="tr7asev">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7asev" value="செவ்வாய்" onclick="return uncheck('asev','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">செ</td>
        </tr>
        <tr id="tr7alac">
          <td style="padding-left:3px; font-size:12px;"><input type="checkbox" name="amsam7[]" id="7alac" value="லக்னம்" onclick="return uncheck('alac','7')">
          </td>
          <td style="font-size:13px;">&nbsp;</td>
          <td style="font-size:13px;">ல</td>
        </tr>
