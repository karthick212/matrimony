...
elseif($mode=='female')
{
  ...
  echo "Choose the tab";
                        ...
                        //echo $sql;
                                ...
                                ?>
							    <tr>
								    <td><a href="viewprofile.php?id=<?php echo $fetch['matri_id']; ?>" target="_blank"><?php echo $s++; ?></a></td>
								    <td><a href="viewprofile.php?id=<?php echo $fetch['matri_id']; ?>" target="_blank"><?php echo $fetch['matri_id']; ?></a></td>
								    <td><a href="viewprofile.php?id=<?php echo $fetch['matri_id']; ?>" target="_blank"><?php echo $fetch['name']; ?></a></td>
                                    <td><a href="viewprofile.php?id=<?php echo $fetch['matri_id']; ?>" target="_blank"><?php echo $fetch['caste']; ?></a></td>
                                    <td><a href="viewprofile.php?id=<?php echo $fetch['matri_id']; ?>" target="_blank"><?php echo $fetch['subcaste']; ?></a></td>
