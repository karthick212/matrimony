...
<h4  style="color:green; position: fixed; text-align: right;"  ><a href="stafflogin.php"> <span style="background-color: yellow;">Logout</span></a></h4>
    ...
    <tr ><!-- <td valign="bottom" height="" colspan="2" align="center" style="font-weight:bold; font-size:14px;font-weight:bold; color: #246d01;">ஸ்ரீ லிங்கம்மாள் துணை</td> --></tr>
      ...
      <td width="346"> <table width="246" border="0" cellspacing="0" cellpadding="0">
       ...
       <th width="242" scope="col" align="left"  style="font-size:14px; padding:12px;font-weight:bold; color: #d8348e;" >
            ...
            <td width="10">
              <th style="background-color: red;"><a href="edit1.php?id=<?php echo  $row['matri_id'];?>" ><span style="color: white;" >Edit Profile</span></a></th>
          </tr>
    ...
    <td height="">
     ...
     <tr>
      ...
      <tr>
        ...
        <td>:</td>
        <td width="388" style="font-weight:bold;font-size:16px;"><span style=" font-size:12px;">நாள்</span>:<?php echo  $row['thisai_date'];?>
   <img src="images/main.jpg" width="50%" height="40%" style="margin-top: -37em;margin-left:12em;"></td>
  ...
  <table width="1003" border="0" cellspacing="0" cellpadding="0" align="center" class="b" style="font-weight:bold;font-size:16px;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?>">
      <tr valign="top">
        ...
        <table  border="1" align="center" cellpadding="0"  id="table6" style="border-collapse: collapse;">
            <tbody class="b" style="font-weight:bold;font-size:18px;line-height: 1.0;"><tr class="b" style="font-weight:bold;font-size:18px;">
              <td width="77"  >
...
foreach ($array as $item) {
  ...
  <?php $t=trim($item); echo $t; }  ?>
              ...
              <td width="77">
              <textarea  class="a" style="overflow: hidden;<?php /*?>font-family: Bamini, Helvetica, sans-serif;<?php */?> font-weight: bold; color: red; text-align:justify;  font-size:14px;font-weight:bold;" rows="6" name="r1" cols="11" tabindex="48"> <?php   $row['r9'];?> <?php
$c9=$row['nine'];       
$array =  explode(',', $c9);
foreach ($array as $item) {
  //echo $item;
