...
">
     ...
     echo "testttttt";
          ...
          if(isset($_POST['sub']))
          {
           ...
           //   //echo $file_to_saved;
           //  $ve=move_uploaded_file($fname,$file_to_saved);
           //  echo $ve;
           //  if($ve){
           //    echo "doneeeeeee";
           //  }
    ...
    $target_dir1 = "photos/".basename($new_image);
      if($new_image != "")
      {
        ...
        else
        {
          ...
          //$message = "";
          /*echo "<script type='text/javascript'>alert('$message');</script>";*/
         $sql2="UPDATE registerfree SET up_profile='$target_dir1' WHERE matri_id='$mat_id' ";
            $res2 = mysql_query($sql2);
            if($sql2){
              echo "<script> confirm('Profile Picture Updated successfully...!');window.location.href='m_viewprofile.php?id=$mat_id';</script>";
